...
const projcetItems = [
  {
    ...
    description: (
      <>
        ...
        articles on the latest trends and news.
      </>
    ),
    techStacks: ["React", "Redux", "Javascript", "Node.js", "CMS"],
  ...
  },
  {
    ...
    description: (
      <>
        Hero Mobile App is a re-designed app for Hero Innovative Group that
        assists customers in applying for, managing, and monitoring their
        prepaid cards, including functionalities for spending and topping up.
      </>
    ),
